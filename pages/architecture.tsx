...
const Architecture: NextPage<{ goodPractices: GoodPracticesType[], recommendations: string[] }> = ({ goodPractices, recommendations }) => {
  ...
  return <>
    <Head>
      <title>Black 4 Green | Architecture</title>
...
export async function getStaticProps() {
  ...
  const goodPractices = GoodPracticesModel.getGoodPracticesWithFilter(Filters.family, 'ARCHITECTURE'),
    recommendations = GoodPracticesModel.getRecommendationsWithFilter(Filters.family, 'ARCHITECTURE')
