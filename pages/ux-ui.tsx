...
const UXUI: NextPage<{ goodPractices: GoodPracticesType[], recommendations: string[] }> = ({ goodPractices, recommendations }) => {
  ...
  return <>
    <Head>
      <title>Black 4 Green | UX/UI</title>
...
export async function getStaticProps() {
  ...
  const goodPractices = GoodPracticesModel.getGoodPracticesWithFilter(Filters.family, 'UX/UI'),
    recommendations = GoodPracticesModel.getRecommendationsWithFilter(Filters.family, 'UX/UI')
